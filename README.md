...
## XFLR5/FLOW5 
(I will be learning how to use FLOW5)
...
- Next we want to refine our airfoils so they are smoother, like my brain. So after selecting the desired airfoil, **press F9**, or R_Click the airfoil > Modify > Refine Globally, increase the number of panels to somewhere in the range of 150-250. Too many will make your computer toasty and may prevent convergence. I did 200.
